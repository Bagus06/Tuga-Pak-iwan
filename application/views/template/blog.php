                        ...
                        <div class="row">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content blog">
                                        <a href="articles.html">
                                            <h4>One morning, when Gregor Samsa</h4>
                                        </a>
                                        <!-- Date -->
                                        <div class="blog-date">
                                            <p><strong>Adam Smith</strong> <span><i class="fa fa-clock-o"></i> 28th Oct 2018</span></p>
                                        </div>
                                        <p>English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web
                                        </p>

                                        <div class="row">
                                            <div class="col-md-8">
                                                <h6 class="blog-tag">Tags:</h6>
                                                <button class="btn btn-primary btn-xs" type="button">Model</button>
                                                <button class="btn btn-white btn-xs" type="button">Publishing</button>
                                            </div>
                                            <div class="col-md-4">
                                                <!-- Comments -->
                                                <div class="blog-comme text-right">
                                                    <h5 class="comme-stats">Stats:</h5>
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content blog">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <h5 class="blog-tag">Tags:</h5>
                                                <button class="btn btn-primary btn-xs" type="button">Model</button>
                                                <button class="btn btn-white btn-xs blog" type="button">Publishing</button>
                                            </div>
                                            <div class="col-md-4">
                                                <!-- Comments -->
                                                <div class="blog-comme text-right">
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content blog">
                                        <a href="articles.html">
                                            <h4>The bedding was hardly able to cover</h4>
                                        </a>
                                        <!-- Blog Date -->
                                        <div class="blog-date">
                                            <p> <strong>Anthony Dvorak</strong> <span class="text-muted"><i class="fa fa-clock-o"></i> 11th Dec 2014</span></p>
                                        </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content blog">
                                        <a href="articles.html">
                                            <h4>It showed a lady fitted out with</h4>
                                        </a>
                                        <!-- Date -->
                                        <div class="blog-date">
                                            <p> <strong>Mike Smith</strong> <span><i class="fa fa-clock-o"></i> 11th May 2018</span></p>
                                        </div>
                                        <p>The bedding was hardly able to cover it and seemed ready to slide off any moment. His many legs, pitifully thin compared with the size of.</p>
