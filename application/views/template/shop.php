                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/1.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                                            <h6>Items</h6>
                                            <span>fashion Shirt</span>
                                        </div>
                                    ...
                                    <div class="add-to-cart text-center border-top">
                                        <a class="btn m-2 btn-round btn-primary shop" href="product-item.html">View more</a>
                                        <a class="btn m-2 btn-round btn-primary shop" href="cart.html">Add to Cart</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/2.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                                            <h6>Items</h6>
                                            <span>fashion T-shirt</span>
                                        </div>
                                        <div class="shop--item-Rate">
                                            <h6>$500</h6>
                                            <span>$378</span>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/3.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/4.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/5.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/6.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/7.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/8.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                <div class="shop-product-content mb-30">
                                    <!-- Img -->
                                    <div class="shop--img">
                                        <img src="img/shop-img/9.jpg" alt="">
                                    </div>
                                    <!-- Product Text -->
                                    <div class="shop-product--text d-flex">
                                        <div class="shop--item-desc">
