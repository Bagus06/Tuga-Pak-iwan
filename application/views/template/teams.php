            ...
            <div class="layout-container sidemenu-container">
                ...
                <div class="wrapper wrapper-content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="teams--area bg-boxshadow">
                                    <div class="row justify-content-center">
                                        <div class="col-12">
                                            <div class="team_title mb-30">
                                                <h4>Style - 1</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <!-- Teams Content Area -->
                                            <div class="teams_content_area">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-4.jpg" alt="">
                                                <!-- Hover -->
                                                <div class="team_hover_effect_1 d-flex align-items-center justify-content-center">
                                                    <!-- Text -->
                                                    <div class="team_text">
                                                        <h5>Lina Smith</h5>
                                                        <p>Developer</p>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            ...
                                            <div class="teams_content_area">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-5.jpg" alt="">
                                                <!-- Hover -->
                                                <div class="team_hover_effect_1 d-flex align-items-center justify-content-center">
                                                    <!-- Text -->
                                                    <div class="team_text">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            ...
                                            <div class="teams_content_area">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-6.jpg" alt="">
                                                <!-- Hover -->
                                                <div class="team_hover_effect_1 d-flex align-items-center justify-content-center">
                                                    <!-- Text -->
                                                    <div class="team_text">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            ...
                                            <div class="teams_content_area">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-7.jpg" alt="">
                                                <!-- Hover -->
                                                <div class="team_hover_effect_1 d-flex align-items-center justify-content-center">
                                                    <!-- Text -->
                                                    <div class="team_text">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            ...
                                            <div class="teams_content_area">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-8.jpg" alt="">
                                                <!-- Hover -->
                                                <div class="team_hover_effect_1 d-flex align-items-center justify-content-center">
                                                    <!-- Text -->
                                                    <div class="team_text">
                                                        <h5>Connor Charles</h5>
                                                        <p>Marketing Head</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <!-- Teams Content Area -->
                                            <div class="teams_content_area style_2">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-3.jpg" alt="">
                                                <!-- Hover -->
                                                <div class="team_hover_effect_2">
                                                    <!-- Text -->
                                                    <div class="team_text style_2">
                                                        <h5>Zara Smith</h5>
                                                        <p>Developer</p>
                                                    </div>
                                                    <div class="personal_team_info">
                                                        <p>It is a long established fact that a reader will be distracted by the.</p>
                                                        <div class="team_icon_info">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <!-- Teams Content Area -->
                                            <div class="teams_content_area_style_3 mb-30 bg-boxshadow">
                                                <!-- Thumb -->
                                                <img src="img/member-img/member-2.jpg" alt="">
                                                <!-- Text -->
                                                <div class="team_text_style_3 text-center">
                                                    <h5>Zara Smith</h5>
                                                    <p>Developer</p>
                                                </div>
                                                <!-- Icon -->
                                                <div class="team_icon_info_style_3 text-center">
                                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-skype" aria-hidden="true"></i></a>
                                                    <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
