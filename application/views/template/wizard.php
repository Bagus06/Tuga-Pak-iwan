                ...
                <div class="wrapper wrapper-content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <!-- Jumbotron -->
                                <div class="jumbotron-wizard bg-boxshadow mb-30">
                                    <h4>Steps</h4>
                                    <p>Smart UI component which allows you to easily create wizard-like interfaces.</p>
                                    <p><a href="http://www.jquery-steps.com/GettingStarted" target="_blank" class="btn btn-primary">About jQuery Steps</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <!-- Ibox -->
                                <div class="ibox wizard bg-boxshadow">
                                    <!-- Ibox Title -->
                                    <div class="ibox-title-wizard">
                                    ...
                                    <div class="ibox-content p-0">
                                        <form id="form" action="#">
                                            <fieldset>
                                                <h5 class="wizard-title">Account Information</h5>
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <!-- Form Group -->
                                                        ...
                                                        <div class="wizard-sign-button mb-30">
                                                            <a href="#">Next</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <fieldset>
                                                <h5 class="wizard-title">Profile Information</h5>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <!-- Form Group -->
                                                        <div class="form-group">
