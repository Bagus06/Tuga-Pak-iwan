                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    <!-- Ibox Title -->
                                    <div class="ibox-title">
                                        <h6 class="mb-30">Multiple Area</h6>
                                    </div>
                                    <!-- Ibox Content -->
                                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    <!-- Ibox Title -->
                                    <div class="ibox-title">
                                        <h6 class="mb-30">Multiple Line</h6>
                                    </div>
                                    <!-- Ibox Content -->
                                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    <!-- Ibox Title -->
                                    <div class="ibox-title">
                                        <h6 class="mb-30">Stacked Bars</h6>
                                    </div>
                                    <!-- Ibox Content -->
                                    <div class="ibox-content">
