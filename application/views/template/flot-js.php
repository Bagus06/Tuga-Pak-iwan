                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="layout-content">
                                    <div class="demo-vertical-chart-lg">
                                        <div class="flot-graph-bar bg-boxshadow mb-50">
                                            <div id="flot-graph"></div>
                                        </div>
                                        <div class="flot-bar-chart bg-boxshadow mb-50">
                                            <div id="flot-bars"></div>
                                        </div>
                                        <div class="flot-categori bg-boxshadow mb-50">
                                            <div id="flot-categories"></div>
                                        </div>
                                        <div class="flot-pie bg-boxshadow mb-50">
                                            <div id="flot-pie"></div>
                                        </div>
