                        ...
                        <div class="col-12">
                            ...
                            <div class="resizable-panels">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    <div class="ibox-title resizeable">
                                        <h6>Resizable</h6>
                                    </div>
                                    <!-- Content -->
                                    <div class="ibox-content resizeable">
                                        <h4>This is simple box container nr. 1</h4>
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <!-- Content -->
                                    <div class="ibox-content resizeable">
                                        <h4>This is simple box container nr. 2</h4>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                </div>
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <!-- Content -->
                                    <div class="ibox-content resizeable">
                                        <h4>This is simple box container nr. 3</h4>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                </div>
                                <!-- Ibox -->
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <!-- Content -->
                                    <div class="ibox-content resizeable">
                                        <h4>This is simple box container nr. 4</h4>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                </div>
                            </div>
