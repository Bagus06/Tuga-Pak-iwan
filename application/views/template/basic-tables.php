                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="basic-tables-area bg-boxshadow">
                                    ...
                                    <!-- Table Head -->
                                    <h5 class="text-muted py-3 my-4">Table head options</h5>
                                    ...
                                    <!-- Table Striped -->
                                    <h5 class="text-muted py-3 my-4">Striped rows</h5>
                                    ...
                                    <!-- Table Hover -->
                                    <h5 class="text-muted py-3 my-4">Hoverable rows</h5>
                                    ...
                                    <!-- Small Table -->
                                    <h5 class="text-muted py-3 my-4">Small table</h5>
                                    ...
                                    <!-- Responsive Table -->
                                    <h5 class="text-muted py-3 my-4">Responsive table</h5>
