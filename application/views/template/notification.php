                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="alert alert-primary alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is a primary alert — check it out!
                                    </div>
                                    <!-- Alert -->
                                    <div class="alert alert-secondary alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is a secondary alert — check it out!
                                    </div>
                                    <!-- Alert -->
                                    <div class="alert alert-success alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is a success alert — check it out!
                                    </div>
                                    <!-- Alert -->
                                    <div class="alert alert-danger alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is a danger alert — check it out!
                                    </div>
                                    <!-- Alert -->
                                    <div class="alert alert-warning alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is a warning alert — check it out!
                                    </div>
                                    <!-- Alert -->
                                    <div class="alert alert-info alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is an info alert — check it out!
                                    </div>
                                    <!-- Alert -->
                                    <div class="alert alert-dark alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert">×</button> This is a dark alert — check it out!
                                    </div>
                                </div>
